        ...
        <div className="flex flex-col-reverse lg:flex-row justify-between gap-16 lg:gap-24">
          ...
          <div className="flex-1 lg:max-w-md w-full">
            ...
            >
              ...
              <form className={`${roboto.className} space-y-6`} action="https://formspree.io/f/mqewqeed" method="POST"> //  form integeration with formspree.io for handling contact form submissions
                <div>
